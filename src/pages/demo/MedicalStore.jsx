...
export default function MedicalStore() {
  return (
    <div className="bg-gray-50 text-gray-800 min-h-screen">
      ...
      {/* Header */}
      <header className="bg-sky-800 text-white p-4 flex justify-between items-center shadow-xs">
        <h1 className="text-xl font-bold">
          Shree Ambica Medical Store
        </h1>
        <a
          href="tel:9876543210"
          className="bg-white text-sky-900 font-semibold px-4 py-1.5 rounded-lg text-sm"
        >
          Call Now
        </a>
      </header>
      ...
      {/* Hero */}
      <section className="bg-white text-center py-12 px-4 border-b border-gray-100">
        ...
        <a
          ...
          className="inline-block bg-sky-700 text-white px-6 py-3 rounded-xl text-base font-semibold hover:bg-sky-800 transition shadow-sm"
        >
          Order via WhatsApp
        </a>
      </section>

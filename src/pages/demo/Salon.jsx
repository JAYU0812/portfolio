...
export default function Salon() {
  ...
  return (
    <div className="bg-stone-50 text-stone-800 min-h-screen">
      ...
      {/* Header */}
      <header className="bg-[#A03E5C] text-white p-3.5 sm:p-4 flex justify-between items-center shadow-xs">
        <h1 className="text-base sm:text-xl font-serif font-bold tracking-wide truncate mr-2">
          Glow Beauty Salon & Studio
        </h1>
        <a
          href="tel:9876543210"
          className="bg-white text-[#A03E5C] font-semibold px-3 sm:px-4 py-1.5 rounded-lg text-xs sm:text-sm shrink-0"
        >
          Call Now
        </a>
      </header>
      ...
      {/* Hero */}
      <section className="bg-white text-center py-10 sm:py-14 px-4 border-b border-stone-100">
        <h2 className="text-2xl sm:text-4xl font-serif font-bold mb-3 text-stone-900">
          Curated Grooming & Aesthetic Beauty
        </h2>
        <p className="text-stone-600 mb-6 max-w-xl mx-auto text-xs sm:text-sm">
        ...
        <a
          ...
          className="inline-block bg-[#A03E5C] text-white px-6 sm:px-7 py-3 rounded-xl text-sm sm:text-base font-semibold hover:bg-[#862E49] transition shadow-sm"
        >
      ...
      <section className="py-10 sm:py-12 px-4 max-w-5xl mx-auto">
        <h3 className="text-xl sm:text-2xl font-serif font-bold text-center mb-6 sm:mb-8 text-stone-900">

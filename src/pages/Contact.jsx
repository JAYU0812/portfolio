      ...
      <section className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* WhatsApp Quick Card */}
            <div className="bg-[#121316] text-white p-7 rounded-3xl border border-[#2B2E36] shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-xl bg-emerald-600/20 text-emerald-400 flex items-center justify-center">
                  <MessageCircle className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-bold text-base">Direct WhatsApp Chat</h3>
                  <p className="text-xs text-[#A4ACB9]">Fastest response channel</p>
                </div>
              </div>
              <p className="text-xs text-[#A4ACB9] mb-5 leading-relaxed">
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs transition shadow-xs"
              >
            ...
            <div className="bg-white p-7 rounded-3xl border border-[#E8E5DF] shadow-xs space-y-5">
              <h3 className="text-sm font-bold text-[#121316] pb-3 border-b border-[#F2EDE4]">
                Contact Information
              </h3>

              {/* Email with copy button */}
              <div className="flex items-center justify-between p-3 rounded-xl bg-[#FBF9F5] border border-[#E8E5DF]">
                <div className="flex items-center gap-3">
                  <Mail className="w-4 h-4 text-[#C27803]" />
                  <div>
                    <p className="text-[10px] font-mono text-[#7A7E89]">Email Address</p>
                    <p className="text-xs font-semibold text-[#121316]">jay0812soni@gmail.com</p>
                  </div>
                </div>
                <button
                  onClick={handleCopyEmail}
                  className="p-2 rounded-lg hover:bg-white text-[#4A4E57] hover:text-[#121316] transition cursor-pointer"
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-[#FBF9F5] border border-[#E8E5DF]">
                <Phone className="w-4 h-4 text-[#C27803]" />
                <div>
              ...
              {/* Location */}
              <div className="flex items-center gap-3 p-3 rounded-xl bg-[#FBF9F5] border border-[#E8E5DF]">
                <MapPin className="w-4 h-4 text-[#C27803]" />
                <div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-7 sm:p-10 rounded-3xl border border-[#E8E5DF] shadow-xs">
              <div className="mb-6">
                <h3 className="text-xl font-bold text-[#121316] mb-1">
              ...
              <form onSubmit={handleMailtoSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-[#E8E5DF] bg-[#FBF9F5] text-sm text-[#121316] focus:outline-none focus:border-[#C27803] focus:bg-white transition"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-mono font-semibold text-[#121316] mb-1.5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-[#E8E5DF] bg-[#FBF9F5] text-sm text-[#121316] focus:outline-none focus:border-[#C27803] focus:bg-white transition resize-none"
                  ></textarea>
                </div>
